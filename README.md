...
```
docker pull bixos/tronquickstart
```
...
To be updated, take a look at https://hub.docker.com/r/bixos/tronquickstart/tags/
...
__2.1.1__
* Upgrade all java files.
* Add event subscribe to FullNode.
